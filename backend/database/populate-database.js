...
const sampleData = {
  // Sample users (you'll need to replace with real user IDs from auth.users)
  users: [
    {
      id: '00000000-0000-0000-0000-000000000001', // Replace with real user ID
      email: 'demo@wastewise.com',
      first_name: 'Demo',
      last_name: 'User',
      company_name: 'Demo Coffee Chain',
      company_size: 'medium',
      ...
      primary_goals: ['waste_reduction', 'cost_optimization'],
  ...
  coffee_chains: [
    {
      id: uuidv4(),
      user_id: '00000000-0000-0000-0000-000000000001', // Replace with real user ID
...
async function populateDatabase() {
  try {
    ...
    // Step 1: Create users (you need to replace with real user IDs from auth.users)
    ...
    // Step 6: Create menu/recipe data
    ...
    // Step 13: Create recommendations
    ...
    // Step 14: Create subscription plans
