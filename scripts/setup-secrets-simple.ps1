...
Write-Host "All secrets have been created/updated!" -ForegroundColor Green
...
Write-Host "IMPORTANT: Replace placeholder values with your actual credentials!" -ForegroundColor Red
